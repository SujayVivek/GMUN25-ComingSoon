...
export function Home() {
  return (
    ...
    (<BackgroundBeamsWithCollision>
      ...
      <h2
        className="dark:text-yellow-300 text-2xl relative z-25 md:text-4xl lg:text-7xl font-bold text-center text-black dark:text-white font-sans tracking-tight ">
